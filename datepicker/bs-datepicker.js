...
<button class="nav-button next-year" data-symbol="»"></button>
    ...
    function updateHeaderText() {
        monthYearText.textContent = `${bsMonthNames[currentBSDate.bs_month - 1]} ${currentBSDate.bs_year}`;
    }
    ...
    function renderYearMonthView() {
        ...
        years.forEach(year => {
            ...
            yearDiv.addEventListener('click', (e) => {
                ...
                yearMonthContent.querySelectorAll('.month-list').forEach(list => list.remove());
